...
namespace BullBot.Modules
{
    public class Configuration : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task AddRank([Remainder]string name)
        {
            ...
            {
                await ReplyAsync("That tole has a higher position than the bot!");
                return;
            }
            ...
            await ReplyAsync($"The role {role.Mention} has been created!");
        }
        ...
        public async Task Welcome(string option = null, string value = null)
        {
            if (option == null && value == null)
            {
                ...
                {
                    await ReplyAsync("A welcome channel has not been set.");
                    return;
                }
