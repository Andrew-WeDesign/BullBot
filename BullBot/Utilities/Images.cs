...
namespace BullBot.Utilities
{
    public class Images
    {
        public async Task<string> CreateImageASync(SocketGuildUser user, string url = "https://images.unsplash.com/photo-1468581264429-2548ef9eb732?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80")
        {
        ...
        private static Bitmap CropToBanner(Image image)
        {
            ...
            var widthScale = Convert.ToInt32(destinationSize.Height * ratio);
        ...
        private Image DrawTextToImage(Image image, string header, string subheader)
        {
            ...
            GrD.DrawString(subheader, roboto, brushGrey, subheaderX, subheaderY, drawFormat);
        ...
        private async Task<Image> FetchImageAsync(string url)
        {
            ...
            {
                var backupResponse = await client.GetAsync("https://images.unsplash.com/photo-1468581264429-2548ef9eb732?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80");
